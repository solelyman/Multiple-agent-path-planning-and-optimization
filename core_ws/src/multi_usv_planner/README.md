...
The contouring MPC solver is generated using the acados Python interface. To regenerate the solver:
...
```bash
# Launch 3 USVs with dynamic obstacles
...
Key configuration files are in `config/`:
...
@misc{multi_usv_planner2025,
  ...
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/your-repo/multi_usv_planner}
}
```
